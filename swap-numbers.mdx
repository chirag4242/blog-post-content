...
![Hero Image]("./images/swap-heroImage.jpg")
...
![Explanation: (https://devexplanation.hashnode.dev/swap-two-numbers-with-programming)]("./images/explanation_1.jpg")
...
Code:
![Explanation: (https://devexplanation.hashnode.dev/swap-two-numbers-with-programming)]("./images/explanation_2.jpg")
